...
class CAPM:
    ...
    def download_data(self):
        ...
        ticker = yf.download(self.stocks, self.start_date, self.end_date, auto_adjust=True)
        data = ticker['Close']
        # print(data)
    ...
    def initialize(self):
        ...
        # use monthly return instead of daily returns
    ...
    def calculate_beta(self):
        # covariance matrix : diagonal items of variances:
        # matrix is symmetric
    ...
    def regression(self):
        #  slope is beta. Use linear regression
        beta, alpha = np.polyfit(self.data['m_returns'], self.data['s_returns'], deg=1)
        print("Beta from regression: ", beta)
        # calculate expected returns acc to CAPM formula
        # for annual returns multiply by 12
...
if __name__ == '__main__':
    ...
    capm = CAPM(['ORCL', '^GSPC'],'2017-01-01', '2025-03-23')
    capm.initialize()
    capm.calculate_beta()
    capm.regression()