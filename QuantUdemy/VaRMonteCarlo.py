...
def download_data(stock, start, end):
    ...
    ticker = yf.download(stock, start, end, auto_adjust=True)
...
class ValueAtRiskMonteCarlo:
    ...
    def simulation(self):
        ...
        # random walk of our initial investment
        ...
        # it depends on confidence level: 95% -> 5, 99% -> 1
        # 1-0.99 = 0.01, 0.01*100 = 1
...
if __name__ == '__main__':
    ...
    c = 0.95  # confidence level: this time it is 99%
    n = 1  # 1 day
